...
public class Menu extends javax.swing.JPanel {
   ...
   public void addEventMenuSelected(EventMenuSelected event) {
    ...
    private void init() {
        ...
        listMenu2.addItem(new Model_Menu("2", "Bạn", Model_Menu.MenuType.MENU));
        listMenu2.addItem(new Model_Menu("3", "AD", Model_Menu.MenuType.MENU));
        listMenu2.addItem(new Model_Menu("4", "Hướng dẫn", Model_Menu.MenuType.MENU));
        listMenu2.addItem(new Model_Menu("5", "Chính sách", Model_Menu.MenuType.MENU));
        listMenu2.addItem(new Model_Menu("5", "Hỗ trợ", Model_Menu.MenuType.MENU));

        listMenu2.addItem(new Model_Menu("6", "Kho", Model_Menu.MenuType.MENU));
